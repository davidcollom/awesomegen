...
const FooterStr = "*Generated by [awesomegen](https://github.com/davidcollom/awesomegen).*"
...
func TestMarkdownVariants(t *testing.T) {
	...
	for _, tt := range tests {
		t.Run(tt.name, func(t *testing.T) {
			...
			require.Contains(t, tt.contains, FooterStr, "The footer wasn't found in the output")
